...
Registering User(as a customer and/or a delivery guy), making a profile and authentication for accessing certain areas of the web app.
Customer can create a Job  which can now be seen as availabe jobs for delivery drivers. Job can be cancelled untill a deilvery driver has accepted it.
They can accept the job, pickup and then deliver the product which will be updated on the app.
Delivery drivers have to click and upload photos of the delivery package once those stages have been completed. All this is saved in our database.
