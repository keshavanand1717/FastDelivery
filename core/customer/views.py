...
def create_job_page(request):
    ...
    # creating_job = Job.objects.filter(customer=current_customer, status = Job.CREATING_STATUS).
    #SOME debugging req.
    creating_job = forms.Job.objects.filter(customer=current_customer, status = forms.Job.CREATING_STATUS).last()
